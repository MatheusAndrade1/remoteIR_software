...
def main():
    # ------ Menu Definition ------ #      
    menu_def = [['File', ['Open', 'Save As...', 'Properties']],      
    ...
    layout = [
        ...
        [sg.InputCombo(values=COMS,key='porta', default_value=getName('COM'), **ic),sg.InputCombo(values=BAUD,key='baud', default_value=getName('baudrate'), **ic)],
